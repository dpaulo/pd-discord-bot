      ...
      if (!resDB) {
        ...
        const embed = new MessageEmbed()
          ...
          .addFields(
            {
              name: `Sale price ${
                resItem.lowest_price > resDB.lowest_price ? "increased 🟩" : resItem.lowest_price < resDB.lowest_price ? "dropped 🟥" : "didn't change ⬜"
              }`,
              value: `$${Math.abs(
            ...
            {
              name: `Median price ${
                resItem.median_price > resDB.median_price ? "increased 🟩" : resItem.median_price < resDB.median_price ? "dropped 🟥" : "didn't change ⬜"
              }`,
              value: `$${Math.abs(
